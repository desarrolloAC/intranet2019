...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-11-2018 a las 11:48:22
...
(1, 'Y', '2018-11-22 08:26:11', '2018-11-22 08:26:11', 'Sala Alkes', 2, 'Enero', '2018'),
(2, 'Y', '2018-11-22 08:26:11', '2018-11-22 08:26:11', 'Sala Venfruca', 2, 'Enero', '2018'),
(3, 'Y', '2018-11-22 08:26:11', '2018-11-22 08:26:11', 'Sala Caiman', 2, 'Enero', '2018'),
(4, 'Y', '2018-11-22 08:26:11', '2018-11-22 08:26:11', 'Sala Alkes', 2, 'Enero', '2018'),
(5, 'Y', '2018-11-22 08:26:11', '2018-11-22 08:26:11', 'Sala Frutech', 2, 'Enero', '2018'),
(6, 'Y', '2018-11-22 08:26:11', '2018-11-22 08:26:11', 'Sala Comedor', 2, 'Enero', '2018'),
(7, 'Y', '2018-11-22 08:26:11', '2018-11-22 08:26:11', 'Sala Jardin', 2, 'Enero', '2018'),
(8, 'Y', '2018-11-22 08:26:11', '2018-11-22 08:26:11', 'Sala Machete', 2, 'Enero', '2018');
...
CREATE TRIGGER `create_reservations` AFTER INSERT ON `availability` FOR EACH ROW BEGIN
    ...
    (NULL,DEFAULT,DEFAULT,DEFAULT,'8:00 am','9:00 am','-',DEFAULT,NEW.availability_id),
    (NULL,DEFAULT,DEFAULT,DEFAULT,'9:00 am','10:00 am','-',DEFAULT,NEW.availability_id),
    (NULL,DEFAULT,DEFAULT,DEFAULT,'10:00 am','11:00 am','-',DEFAULT,NEW.availability_id),
    (NULL,DEFAULT,DEFAULT,DEFAULT,'11:00 am','12:00 am','-',DEFAULT,NEW.availability_id),
    (NULL,DEFAULT,DEFAULT,DEFAULT,'12:00 am','1:00 am','-',DEFAULT,NEW.availability_id),
    (NULL,DEFAULT,DEFAULT,DEFAULT,'1:00 am','2:00 am','-',DEFAULT,NEW.availability_id),
    (NULL,DEFAULT,DEFAULT,DEFAULT,'2:00 am','3:00 am','-',DEFAULT,NEW.availability_id),
    (NULL,DEFAULT,DEFAULT,DEFAULT,'3:00 am','4:00 am','-',DEFAULT,NEW.availability_id),
    (NULL,DEFAULT,DEFAULT,DEFAULT,'4:00 am','5:00 am','-',DEFAULT,NEW.availability_id);
  END
$$
DELIMITER ;
...
INSERT INTO `cargo` (`ID_Cargo`, `ID_Departamento`, `Nombre`, `Estatus`, `Created`, `CreatedBy`, `Updated`, `UpdatedBy`, `Descripcion`) VALUES
('1', 'TI', 'ANALISTA FUNCIONAL', 'A', '2018-11-19 21:49:12', '18891494', '2018-11-19 21:49:12', '18891494', 'ANALISTA FUNCIONAL'),
('2', 'TI', 'ANALISTA INFORMÁTICO', 'A', '2018-11-19 21:49:51', '18891494', '2018-11-19 21:49:51', '18891494', 'ANALISTA INFORMÁTICO'),
('3', 'VE', 'ANALISTA DE VENTAS', 'A', '2018-11-19 21:51:06', '18891494', '2018-11-19 21:51:06', '18891494', 'ANALISTA DE VENTAS'),
('qweq', 'TI', 'cargo de  ', 'A', '2018-11-23 19:35:58', '18891494', '2018-11-23 19:38:02', '18891494', 'comprasssssweeeeeeeeeeeeeeeeeeeeeeeeeeeeee');
...
INSERT INTO `categoria` (`ID_Categoria`, `Nombre`, `Estatus`, `Created`, `CreatedBy`, `Updated`, `UpdatedBy`, `Descripcion`) VALUES
('CE', 'CELEBRACIONES', 'A', '2018-11-19 21:55:41', '18891494', '2018-11-19 21:55:41', '18891494', 'CELEBRACIONES'),
('CI', 'CAPSULA INFORMATIVA', 'A', '2018-11-19 21:51:51', '18891494', '2018-11-19 21:51:51', '18891494', 'CAPSULA INFORMATIVA'),
('CO', 'CONDOLENCIAS', 'A', '2018-11-19 21:54:28', '18891494', '2018-11-19 21:54:28', '18891494', 'CONDOLENCIAS'),
('FI', 'FOLLETO INFORMATIVO', 'A', '2018-11-19 21:54:02', '18891494', '2018-11-19 21:54:02', '18891494', 'FOLLETO INFORMATIVO'),
('IN', 'INTERACTIVO', 'A', '2018-11-19 21:53:13', '18891494', '2018-11-19 21:53:13', '18891494', 'INTERACTIVO'),
('INF', 'INFOGRAFÍA', 'A', '2018-11-19 21:56:27', '18891494', '2018-11-19 21:56:27', '18891494', 'INFOGRAFÍA'),
('INV', 'INVITACIONES', 'A', '2018-11-19 21:55:13', '18891494', '2018-11-19 21:55:13', '18891494', 'INVITACIONES'),
('TH', 'TALENTO HUMANO', 'A', '2018-11-19 21:52:38', '18891494', '2018-11-19 21:52:38', '18891494', 'TALENTO HUMANO'),
('VP', 'VENTA DE PRODUCTOS', 'A', '2018-11-19 21:57:01', '18891494', '2018-11-19 21:57:01', '18891494', 'VENTA DE PRODUCTOS');
...
CREATE TABLE `departamento` (
  `ID_Departamento` char(4) NOT NULL,
  `ID_Organizacion` char(10) NOT NULL,
  `Nombre` varchar(100) NOT NULL,
  `Estatus` char(1) NOT NULL DEFAULT 'A',
  `Created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `CreatedBy` char(10) NOT NULL,
...
INSERT INTO `departamento` (`ID_Departamento`, `ID_Organizacion`, `Nombre`, `Estatus`, `Created`, `CreatedBy`, `Updated`, `UpdatedBy`, `Descripcion`) VALUES
('TI', 'ALK', 'TECNOLOGÍA DE LA INFORMACIÓN', 'A', '2018-11-19 21:47:21', '18891494', '2018-11-19 21:47:21', '18891494', 'TECNOLOGÍA DE LA INFORMACIÓN'),
('VE', 'ALK', 'VENTAS', 'A', '2018-11-19 21:50:16', '18891494', '2018-11-19 21:50:16', '18891494', 'VENTAS');
...
INSERT INTO `estados` (`ID_ESTADO`, `ID_PAIS`, `ESTADO`, `ISO_3166-2`) VALUES
(1, 1, 'Amazonas', 'VE-X'),
(2, 1, 'Anzoátegui', 'VE-B'),
(3, 1, 'Apure', 'VE-C'),
(4, 1, 'Aragua', 'VE-D'),
...
(14, 1, 'Miranda', 'VE-M'),
(15, 1, 'Monagas', 'VE-N'),
(16, 1, 'Nueva Esparta', 'VE-O'),
(17, 1, 'Portuguesa', 'VE-P'),
(18, 1, 'Sucre', 'VE-R'),
(19, 1, 'Táchira', 'VE-S'),
(20, 1, 'Trujillo', 'VE-T'),
(21, 1, 'Vargas', 'VE-W'),
(22, 1, 'Yaracuy', 'VE-U'),
(23, 1, 'Zulia', 'VE-V'),
(24, 1, 'Distrito Capital', 'VE-A'),
(25, 1, 'Dependencias Federales', 'VE-Z');
...
CREATE TABLE `notificacion` (
  ...
  `CreatedBy` char(10) NOT NULL,
  `Estado_Public` char(20) NOT NULL,
...
INSERT INTO `notificacion` (`ID_Notificacion`, `ID_Publicacion`, `CreatedBy`, `Estado_Public`, `Mensaje`, `leido`, `Fecha`) VALUES
(1, 1, '4567876', 'REVISION_E', 'Anita Tapia, ha Hecho una Nueva Publicación.', 0, '2018-11-24 19:33:37'),
(2, 1, '18891494', 'RECHAZADO_E', 'Roger Romero, ha Rechazado tu Publicación.', 0, '2018-11-24 19:34:22'),
(3, 1, '4567876', 'REVISION_E', 'Anita Tapia, ha Hecho una Nueva Publicación.', 0, '2018-11-24 19:34:53'),
(4, 1, '18891494', 'REVISION_A', 'Roger Romero, te ha Enviado una Publicación.', 0, '2018-11-24 19:35:45'),
(5, 1, '18891494', 'PUBLICADA', 'Roger Romero, ha Realizado una Nueva Publicación.', 0, '2018-11-24 19:36:33'),
(6, 2, '4567876', 'REVISION_E', 'Anita Tapia, ha Hecho una Nueva Publicación.', 0, '2018-11-24 20:01:21'),
(7, 2, '18891494', 'REVISION_A', 'Roger Romero, te ha Enviado una Publicación.', 0, '2018-11-24 20:03:16'),
(8, 2, '18891494', 'PUBLICADA', 'Roger Romero, ha Realizado una Nueva Publicación.', 0, '2018-11-24 20:03:42'),
(9, 3, '4567876', 'REVISION_E', 'Anita Tapia, ha Hecho una Nueva Publicación.', 0, '2018-11-24 20:04:57'),
(10, 4, '18891494', 'REVISION_E', 'Roger Romero, ha Hecho una Nueva Publicación.', 0, '2018-11-25 11:57:11'),
(11, 3, '18891494', 'REVISION_A', 'Roger Romero, te ha Enviado una Publicación.', 0, '2018-11-25 11:57:21'),
(12, 4, '18891494', 'REVISION_A', 'Roger Romero, te ha Enviado una Publicación.', 0, '2018-11-25 11:57:29'),
(13, 3, '18891494', 'PUBLICADA', 'Roger Romero, ha Realizado una Nueva Publicación.', 0, '2018-11-25 11:57:35'),
(14, 4, '18891494', 'PUBLICADA', 'Roger Romero, ha Realizado una Nueva Publicación.', 0, '2018-11-25 11:57:40');
...
INSERT INTO `organizacion` (`ID_Organizacion`, `Nombre`, `Estatus`, `Created`, `CreatedBy`, `Updated`, `UpdatedBy`, `foto`) VALUES
('ALK', 'ALKES', 'A', '2018-11-11 01:31:12', '18891494', '2018-11-11 01:31:12', '18891494', NULL),
('CAI', 'IND EL CAIMAN', 'A', '2018-11-11 01:31:12', '18891494', '2018-11-11 01:31:12', '18891494', NULL),
('VEN', 'VENFRUCA', 'A', '2018-11-19 21:45:31', '18891494', '2018-11-19 21:45:31', '18891494', NULL);
...
INSERT INTO `org_usuario_rol` (`ID_Organizacion`, `ID_Rol`, `Cedula`, `Estatus`, `Created`, `CreatedBy`, `Updated`, `UpdatedBy`) VALUES
('ALK', 'ADM', '18891494', 'A', '2018-11-19 22:09:09', '18891494', '2018-11-19 22:09:09', '18891494'),
('ALK', 'AUT', '19666702', 'A', '2018-11-24 17:24:29', '18891494', '2018-11-24 17:24:29', '18891494'),
('ALK', 'EDT', '1234', 'A', '2018-11-24 17:27:30', '18891494', '2018-11-24 17:27:30', '18891494'),
('ALK', 'PUB', '4567876', 'A', '2018-11-24 17:29:49', '18891494', '2018-11-24 17:29:49', '18891494');
...
CREATE TABLE `publicacion` (
  `ID_Publicacion` int(11) NOT NULL,
  `ID_Organizacion` char(10) NOT NULL,
  `ID_Subcategoria` char(4) NOT NULL,
  `Cedula` char(10) NOT NULL,
  `Contenido` longtext NOT NULL,
  `Estatus` char(1) NOT NULL DEFAULT 'A',
  `Foto` varchar(200) NOT NULL,
  `Titulo` varchar(100) NOT NULL,
  `Estado` char(20) DEFAULT 'BORR',
  `Motivo` varchar(5000) DEFAULT NULL,
  `Created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `CreatedBy` char(10) NOT NULL,
  `Updated` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `UpdatedBy` char(10) NOT NULL,
  `PublicatedBy` char(10) DEFAULT NULL,
  `F_Publicacion` datetime DEFAULT CURRENT_TIMESTAMP
...
INSERT INTO `publicacion` (`ID_Publicacion`, `ID_Organizacion`, `ID_Subcategoria`, `Cedula`, `Contenido`, `Estatus`, `Foto`, `Titulo`, `Estado`, `Motivo`, `Created`, `CreatedBy`, `Updated`, `UpdatedBy`, `PublicatedBy`, `F_Publicacion`) VALUES
(1, 'ALK', 'BI', '4567876', '<p>$estado$estado$estado$estado$estado$estado$estado$estado$estado$estado$estado$estado$estado</p>\r\n', 'A', '/intranet/imagenes/fotoPublicaciones/2018-11-25_003301.png', 'PUBLICACIÓN 1', 'PUBLICADA', NULL, '2018-11-24 19:33:01', '4567876', '2018-11-24 19:36:33', '18891494', NULL, '2018-11-24 19:36:33'),
(2, 'ALK', 'AI', '4567876', '<p><strong>ssssssssssssssssssssssssssssssssssssssssaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</strong>a</p>\r\n', 'A', '/intranet/imagenes/fotoPublicaciones/2018-11-25_010114.PNG', 'public', 'PUBLICADA', NULL, '2018-11-24 20:01:14', '4567876', '2018-11-24 20:03:42', '18891494', NULL, '2018-11-24 20:03:42'),
(3, 'ALK', 'AI', '4567876', '<p>dfsdfsdf</p>\r\n', 'A', '/intranet/imagenes/fotoPublicaciones/2018-11-25_010425.jpg', 'sgsdgsdg', 'PUBLICADA', NULL, '2018-11-24 20:04:25', '4567876', '2018-11-25 11:57:35', '18891494', NULL, '2018-11-25 11:57:35'),
(4, 'ALK', 'CM', '18891494', '<p>dfsdfsdfsdf</p>\r\n', 'A', '/intranet/imagenes/fotoPublicaciones/2018-11-25_165700.PNG', 'ererer', 'PUBLICADA', NULL, '2018-11-25 11:57:00', '18891494', '2018-11-25 11:57:40', '18891494', NULL, '2018-11-25 11:57:40');
...
INSERT INTO `reservation` (`reservation_id`, `isactive`, `created`, `updated`, `cince`, `until`, `user`, `isreserved`, `availability_id`) VALUES
(1, 'Y', '2018-11-27 22:46:48', '2018-11-27 22:46:48', '8:00 am', '9:00 am', 'Nehemias', 'Y', 1),
(2, 'Y', '2018-11-27 22:46:48', '2018-11-27 22:46:48', '9:00 am', '10:00 am', '-', 'Y', 1),
(3, 'Y', '2018-11-27 22:46:48', '2018-11-27 22:46:48', '10:00 am', '11:00 am', '-', 'Y', 1),
(4, 'Y', '2018-11-27 22:46:48', '2018-11-27 22:46:48', '11:00 am', '12:00 am', '-', 'Y', 1),
(5, 'Y', '2018-11-27 22:46:48', '2018-11-27 22:46:48', '12:00 am', '1:00 am', '-', 'Y', 1),
(6, 'Y', '2018-11-27 22:46:48', '2018-11-27 22:46:48', '1:00 am', '2:00 am', '-', 'Y', 1),
(7, 'Y', '2018-11-27 22:46:48', '2018-11-27 22:46:48', '2:00 am', '3:00 am', '-', 'Y', 1),
(8, 'Y', '2018-11-27 22:46:48', '2018-11-27 22:46:48', '3:00 am', '4:00 am', '-', 'Y', 1),
(9, 'Y', '2018-11-27 22:46:48', '2018-11-27 22:46:48', '4:00 am', '5:00 am', '-', 'Y', 1),
(10, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '8:00 am', '9:00 am', '-', 'Y', 2),
(11, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '9:00 am', '10:00 am', '-', 'Y', 2),
(12, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '10:00 am', '11:00 am', '-', 'Y', 2),
(13, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '11:00 am', '12:00 am', '-', 'Y', 2),
(14, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '12:00 am', '1:00 am', '-', 'Y', 2),
(15, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '1:00 am', '2:00 am', '-', 'Y', 2),
(16, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '2:00 am', '3:00 am', '-', 'Y', 2),
(17, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '3:00 am', '4:00 am', '-', 'Y', 2),
(18, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '4:00 am', '5:00 am', '-', 'Y', 2),
(19, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '8:00 am', '9:00 am', '-', 'Y', 3),
(20, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '9:00 am', '10:00 am', '-', 'Y', 3),
(21, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '10:00 am', '11:00 am', '-', 'Y', 3),
(22, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '11:00 am', '12:00 am', '-', 'Y', 3),
(23, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '12:00 am', '1:00 am', '-', 'Y', 3),
(24, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '1:00 am', '2:00 am', '-', 'Y', 3),
(25, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '2:00 am', '3:00 am', '-', 'Y', 3),
(26, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '3:00 am', '4:00 am', '-', 'Y', 3),
(27, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '4:00 am', '5:00 am', '-', 'Y', 3),
(28, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '8:00 am', '9:00 am', '-', 'Y', 4),
(29, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '9:00 am', '10:00 am', '-', 'Y', 4),
(30, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '10:00 am', '11:00 am', '-', 'Y', 4),
(31, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '11:00 am', '12:00 am', '-', 'Y', 4),
(32, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '12:00 am', '1:00 am', '-', 'Y', 4),
(33, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '1:00 am', '2:00 am', '-', 'Y', 4),
(34, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '2:00 am', '3:00 am', '-', 'Y', 4),
(35, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '3:00 am', '4:00 am', '-', 'Y', 4),
(36, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '4:00 am', '5:00 am', '-', 'Y', 4),
(37, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '8:00 am', '9:00 am', '-', 'Y', 5),
(38, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '9:00 am', '10:00 am', '-', 'Y', 5),
(39, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '10:00 am', '11:00 am', '-', 'Y', 5),
(40, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '11:00 am', '12:00 am', '-', 'Y', 5),
(41, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '12:00 am', '1:00 am', '-', 'Y', 5),
(42, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '1:00 am', '2:00 am', '-', 'Y', 5),
(43, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '2:00 am', '3:00 am', '-', 'Y', 5),
(44, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '3:00 am', '4:00 am', '-', 'Y', 5),
(45, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '4:00 am', '5:00 am', '-', 'Y', 5),
(46, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '8:00 am', '9:00 am', '-', 'Y', 6),
(47, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '9:00 am', '10:00 am', '-', 'Y', 6),
(48, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '10:00 am', '11:00 am', '-', 'Y', 6),
(49, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '11:00 am', '12:00 am', '-', 'Y', 6),
(50, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '12:00 am', '1:00 am', '-', 'Y', 6),
(51, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '1:00 am', '2:00 am', '-', 'Y', 6),
(52, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '2:00 am', '3:00 am', '-', 'Y', 6),
(53, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '3:00 am', '4:00 am', '-', 'Y', 6),
(54, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '4:00 am', '5:00 am', '-', 'Y', 6),
(55, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '8:00 am', '9:00 am', '-', 'Y', 7),
(56, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '9:00 am', '10:00 am', '-', 'Y', 7),
(57, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '10:00 am', '11:00 am', '-', 'Y', 7),
(58, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '11:00 am', '12:00 am', '-', 'Y', 7),
(59, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '12:00 am', '1:00 am', '-', 'Y', 7),
(60, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '1:00 am', '2:00 am', '-', 'Y', 7),
(61, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '2:00 am', '3:00 am', '-', 'Y', 7),
(62, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '3:00 am', '4:00 am', '-', 'Y', 7),
(63, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '4:00 am', '5:00 am', '-', 'Y', 7),
(64, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '8:00 am', '9:00 am', '-', 'Y', 8),
(65, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '9:00 am', '10:00 am', '-', 'Y', 8),
(66, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '10:00 am', '11:00 am', '-', 'Y', 8),
(67, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '11:00 am', '12:00 am', '-', 'Y', 8),
(68, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '12:00 am', '1:00 am', '-', 'Y', 8),
(69, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '1:00 am', '2:00 am', '-', 'Y', 8),
(70, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '2:00 am', '3:00 am', '-', 'Y', 8),
(71, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '3:00 am', '4:00 am', '-', 'Y', 8),
(72, 'Y', '2018-11-27 23:56:21', '2018-11-27 23:56:21', '4:00 am', '5:00 am', '-', 'Y', 8);
...
INSERT INTO `rol` (`ID_Rol`, `Nombre`, `Estatus`, `Created`, `CreatedBy`, `Updated`, `UpdatedBy`, `Descripcion`) VALUES
('ADM', 'ADMINISTRADOR', 'A', '2018-11-11 01:36:16', '18891494', '2018-11-11 01:36:16', '18891494', 'Rol con Privilegios Adminisstrativos, que Puede Realizar Todas las Opciones Disponibles en el Sistema. (ROL MASTER)'),
('AUT', 'AUTORIZADOR', 'A', '2018-11-11 01:41:19', '18891494', '2018-11-11 01:41:19', '18891494', 'Rol con Privilegios de Realizar la Carga de las Publicaciones en el Sistema.'),
('EDT', 'EDITOR', 'A', '2018-11-11 01:36:16', '18891494', '2018-11-11 01:36:16', '18891494', 'Rol con Privilegios de Edición, de Publicaciones.'),
('PUB', 'PUBLICADOR', 'A', '2018-11-11 01:41:19', '18891494', '2018-11-11 01:41:19', '18891494', 'Rol con Privilegios Para la Enviar las Publicaciones a los Editores');
...
INSERT INTO `seguridad` (`ID_SEGURIDAD`, `CORREO`, `ESTATUS`, `CLAVE`, `PREGUNTA`, `RESPUESTA`) VALUES
(1, 'roger.romero@alkescorp.com', 'A', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'Nombre de tu Primera Mascota', 'yanke'),
(2, 'nehemias.palacio@alkescorp.com', 'A', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'Nombre de tu Primera Mascota', 'perro'),
(3, 'brayan.martinez@alkescorp.com', 'A', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'Nombre de tu Primera Mascota', 'perro'),
(4, 'ana.tapia@alkescorp.com', 'A', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'Nombre de tu Primera Mascota', 'rrrrrrrreeee');
...
INSERT INTO `subcategoria` (`ID_Subcategoria`, `ID_Categoria`, `Nombre`, `Estatus`, `Created`, `CreatedBy`, `Updated`, `UpdatedBy`, `Descripcion`) VALUES
('AI', 'CI', 'AVANCE INFORMATIVO', 'A', '2018-11-19 21:58:57', '18891494', '2018-11-19 22:54:41', '18891494', 'AVANCE INFORMATIVO'),
('AS', 'TH', 'ASCENSO', 'A', '2018-11-19 22:01:35', '18891494', '2018-11-19 22:01:35', '18891494', 'ASCENSO'),
('BI', 'CE', 'BOLETO INFORMATIVO', 'A', '2018-11-19 21:59:29', '18891494', '2018-11-19 21:59:29', '18891494', 'BOLETO INFORMATIVO'),
('CM', 'CE', 'COMUNICADO', 'A', '2018-11-19 22:00:01', '18891494', '2018-11-19 22:00:01', '18891494', 'COMUNICADO'),
('CP', 'CE', 'CUMPLEAÑEROS DEL MES', 'A', '2018-11-20 05:08:37', '18891494', '2018-11-20 05:08:37', '18891494', 'CUMPLEAÑEROS DEL MES'),
('FA', 'CO', 'FALLECIMIENTOS', 'A', '2018-11-20 05:05:12', '18891494', '2018-11-20 05:05:12', '18891494', 'FALLECIMIENTOS'),
('FL', 'INV', 'FLAYERS', 'A', '2018-11-19 22:03:08', '18891494', '2018-11-19 22:03:08', '18891494', 'FLAYERS'),
('GN', 'INV', 'GENERALES', 'A', '2018-11-19 22:02:25', '18891494', '2018-11-19 22:02:25', '18891494', 'GENERALES'),
('LE', 'TH', 'LOGROS EXTRACURRICULARES', 'A', '2018-11-20 05:03:06', '18891494', '2018-11-20 05:03:06', '18891494', 'LOGROS EXTRACURRICULARES'),
('NH', 'CE', 'NACIMIENTOS DE NIÑAS', 'A', '2018-11-20 05:14:27', '18891494', '2018-11-20 05:14:27', '18891494', 'NACIMIENTOS DE NIÑAS'),
('NI', 'TH', 'NUEVO INGRESO', 'A', '2018-11-19 22:00:56', '18891494', '2018-11-19 22:00:56', '18891494', 'NUEVO INGRESO'),
('NV', 'CE', 'NACIMIENTOS DE NIÑOS', 'A', '2018-11-20 05:13:50', '18891494', '2018-11-20 05:13:50', '18891494', 'NACIMIENTOS DE NIÑOS'),
('PM', 'CE', 'PROMOCIÓN ESCOLAR', 'A', '2018-11-20 05:18:05', '18891494', '2018-11-20 05:18:05', '18891494', 'PROMOCIÓN ESCOLAR'),
('PO', 'TH', 'POSTÚLATE', 'A', '2018-11-20 05:00:51', '18891494', '2018-11-20 05:00:51', '18891494', 'POSTÚLATE');
...
INSERT INTO `usuario` (`Cedula`, `ID_Cargo`, `ID_Pais`, `ID_Estado`, `ID_Municipio`, `ID_Parroquia`, `ID_Ciudad`, `PNombre`, `SNombre`, `PApellido`, `SApellido`, `Correo`, `Telefono`, `Sexo`, `Direccion`, `Estatus`, `Foto`, `Created`, `CreatedBy`, `Updated`, `UpdatedBy`) VALUES
('1234', '3', 1, 7, 88, 283, 122, 'Brayan', 'Menolcito', 'Martinez', 'Menolcito', 'brayan.martinez@alkescorp.com', '04243454544', 'Masculino', 'Valencia, Sector Centro. ', 'A', '/intranet/imagenes/fotoPublicaciones/2018-11-24_222729.png', '2018-11-24 17:27:29', '18891494', '2018-11-24 17:27:29', '18891494'),
('18891494', '2', 1, 12, 148, 486, 212, 'Roger', 'Manuel', 'Romero', 'Colmenares', 'roger.romero@alkescorp.com', '04144119742', 'Masculino', 'san joaquin la pradera', 'A', '/intranet/imagenes/fotoPublicaciones/2018-11-20_030908.jpeg', '2018-11-19 22:09:08', '18891494', '2018-11-19 22:09:08', '18891494'),
('19666702', '2', 1, 7, 83, 271, 117, 'Nehemias', 'Gerardo', 'Palacio', 'Caraballo', 'nehemias.palacio@alkescorp.com', '04123456789', 'Masculino', 'Los guayos, Sector Centro. ', 'A', '/intranet/imagenes/fotoPublicaciones/2018-11-24_222429.png', '2018-11-24 17:24:29', '18891494', '2018-11-24 17:24:29', '18891494'),
('4567876', '1', 1, 18, 309, 809, 376, 'Anita', 'Malefica', 'Tapia', 'Satanica', 'ana.tapia@alkescorp.com', '04269875767', 'Femenino', 'San Joaquin. Centro', 'A', '/intranet/imagenes/fotoPublicaciones/2018-11-24_222949.png', '2018-11-24 17:29:49', '18891494', '2018-11-24 17:29:49', '18891494');
...
ALTER TABLE `estados`
  ...
  ADD KEY `FK_ESTADOS_REF_615_CIUDADES` (`ID_PAIS`);
...
ALTER TABLE `municipios`
  ...
  ADD KEY `FK_MUNICIPI_TIENE2_ESTADOS` (`ID_ESTADO`);
...
ALTER TABLE `org_usuario_rol`
  ADD UNIQUE KEY `org_Rol_Usuario` (`ID_Organizacion`,`ID_Rol`,`Cedula`),
  ADD KEY `fk_OrgUsuRol_Usuario` (`Cedula`),
  ADD KEY `fk_OrgUsuRol_Rol` (`ID_Rol`);
...
ALTER TABLE `parroquias`
  ...
  ADD KEY `FK_PARROQUI_PERTENECE_MUNICIPI` (`ID_MUNICIPIO`);
...
ALTER TABLE `publicacion`
  ...
  ADD KEY `publicacion_subcategoria` (`ID_Subcategoria`),
  ADD KEY `ID_Organizacion` (`ID_Organizacion`),
...
ALTER TABLE `usuario`
  ...
  ADD KEY `ID_Pais` (`ID_Pais`,`ID_Estado`,`ID_Municipio`,`ID_Parroquia`,`ID_Ciudad`),
  ADD KEY `fk_Usu_Estados` (`ID_Estado`),
  ADD KEY `fk_Usu_Municipio` (`ID_Municipio`),
  ADD KEY `fk_Usu_Parroquia` (`ID_Parroquia`),
  ADD KEY `fk_Usu_Ciudad` (`ID_Ciudad`);
...
--
ALTER TABLE `availability`
  MODIFY `availability_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `notificacion`
  MODIFY `ID_Notificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `reservation`
  MODIFY `reservation_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
--
...
--
ALTER TABLE `cargo`
  ADD CONSTRAINT `fk_Dep_Cargo` FOREIGN KEY (`ID_Departamento`) REFERENCES `departamento` (`ID_Departamento`);

--
-- Filtros para la tabla `ciudades`
--
ALTER TABLE `ciudades`
  ADD CONSTRAINT `fk_Ciu_Estados` FOREIGN KEY (`ID_ESTADO`) REFERENCES `estados` (`ID_ESTADO`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `departamento`
--
ALTER TABLE `departamento`
  ADD CONSTRAINT `fk_Dep_Organizacion` FOREIGN KEY (`ID_Organizacion`) REFERENCES `organizacion` (`ID_Organizacion`);

--
-- Filtros para la tabla `estados`
--
ALTER TABLE `estados`
  ADD CONSTRAINT `fk_Est_Paais` FOREIGN KEY (`ID_PAIS`) REFERENCES `paises` (`ID_PAIS`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `mensaje`
--
ALTER TABLE `mensaje`
  ADD CONSTRAINT `mensaje_ibfk_1` FOREIGN KEY (`correo`) REFERENCES `usuario` (`Correo`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `municipios`
--
ALTER TABLE `municipios`
  ADD CONSTRAINT `fk_Mun_Estados` FOREIGN KEY (`ID_ESTADO`) REFERENCES `estados` (`ID_ESTADO`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `notificacion`
--
ALTER TABLE `notificacion`
  ADD CONSTRAINT `fk_Not_Publicacion` FOREIGN KEY (`ID_Publicacion`) REFERENCES `publicacion` (`ID_Publicacion`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Not_Usuario` FOREIGN KEY (`CreatedBy`) REFERENCES `usuario` (`Cedula`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `org_usuario_rol`
--
ALTER TABLE `org_usuario_rol`
  ADD CONSTRAINT `fk_OrgUsuRol_Organizacion` FOREIGN KEY (`ID_Organizacion`) REFERENCES `organizacion` (`ID_Organizacion`),
  ADD CONSTRAINT `fk_OrgUsuRol_Rol` FOREIGN KEY (`ID_Rol`) REFERENCES `rol` (`ID_Rol`),
  ADD CONSTRAINT `fk_OrgUsuRol_Usuario` FOREIGN KEY (`Cedula`) REFERENCES `usuario` (`Cedula`);

--
-- Filtros para la tabla `parroquias`
--
ALTER TABLE `parroquias`
  ADD CONSTRAINT `fk_Parr_Municipios` FOREIGN KEY (`ID_MUNICIPIO`) REFERENCES `municipios` (`ID_MUNICIPIO`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `publicacion`
--
ALTER TABLE `publicacion`
  ADD CONSTRAINT `fk_Pub_Organizacion` FOREIGN KEY (`ID_Organizacion`) REFERENCES `organizacion` (`ID_Organizacion`),
  ADD CONSTRAINT `fk_Pub_Subcategoria` FOREIGN KEY (`ID_Subcategoria`) REFERENCES `subcategoria` (`ID_Subcategoria`),
  ADD CONSTRAINT `fk_Pub_Usuario` FOREIGN KEY (`Cedula`) REFERENCES `usuario` (`Cedula`);
...
--
ALTER TABLE `subcategoria`
  ADD CONSTRAINT `fk_SubC_Categoria` FOREIGN KEY (`ID_Categoria`) REFERENCES `categoria` (`ID_Categoria`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_Usu_Cargo` FOREIGN KEY (`ID_Cargo`) REFERENCES `cargo` (`ID_Cargo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Usu_Ciudad` FOREIGN KEY (`ID_Ciudad`) REFERENCES `ciudades` (`ID_CIUDAD`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Usu_Correo` FOREIGN KEY (`Correo`) REFERENCES `seguridad` (`CORREO`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Usu_Estados` FOREIGN KEY (`ID_Estado`) REFERENCES `estados` (`ID_ESTADO`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Usu_Municipio` FOREIGN KEY (`ID_Municipio`) REFERENCES `municipios` (`ID_MUNICIPIO`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Usu_Pais` FOREIGN KEY (`ID_Pais`) REFERENCES `paises` (`ID_PAIS`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Usu_Parroquia` FOREIGN KEY (`ID_Parroquia`) REFERENCES `parroquias` (`ID_PARROQUIA`) ON DELETE CASCADE ON UPDATE CASCADE;
