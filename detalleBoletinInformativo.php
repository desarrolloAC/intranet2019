...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/detalle/detalleBoletinInformativo.css" media="all"/>
...
<main class="contenedorContenido">
    ...
    <div id="contenidoBOIF" class="contenidoAVIF">
        ...
        const deatalle = new Vue({
            ...
            methods: {
                getPublicaciones: function() {
                    this.$http.get('php/detalle/detalleBoletin.php?id='+getParamURL('id')).then((responsed) => {
