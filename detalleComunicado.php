...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/detalle/detalleComunicado.css" media="all"/>
...
<main class="contenedorContenido">
    ...
    <script type="text/javascript">
        ...
        const detatalleUrl = 'php/detalle/detalleComunicado.php?id='+obtenerValorParametro('id');
