...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/detalle/detalleInvitacionGeneral.css" media="all"/>
        ...
        const deatalle = new Vue({
            ...
            methods: {
                getPublicaciones: function() {
                    this.$http.get('php/detalle/detalleInvitacion.php?id='+getParamURL('id')).then((responsed) => {
