<?php
    ...
    $sql = "SELECT 	pub.ID_Publicacion AS n,
			...
			WHERE cat.ID_Categoria = 'CAIF' AND pub.ID_Subcategoria='BOIF' AND pub.Estatus='A' AND pub.Estado='PUBLICADA' AND pub.ID_Publicacion = $n;"; 
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/detalleNoticiaBOIF.css" media="screen">
...
<body>
	...
	<div id="contenedorContenido">
		...
		<?php
			...
			while ($mostrarBOIF = mysql_fetch_row($result))
	    	{
		
				echo '<div id="contenidoBOIF">

						<div id="contenidoPlantilla">
							'."	<h1 id='titulo'>"	.$mostrarBOIF[7].	"</h1>".'
								<h5 id="org">'		.$mostrarBOIF[1].	"</h5>".'
								<textarea id="contenido" readonly>'		.$mostrarBOIF[9].	"</textarea>".'
						</div>
