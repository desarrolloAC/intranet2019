<?php
    ...
    $sql = "SELECT 	pub.ID_Publicacion AS n,
			...
			WHERE cat.ID_Categoria = 'CAIF' AND pub.ID_Subcategoria='COMU' AND pub.Estatus='A' AND pub.Estado='PUBLICADA' AND pub.ID_Publicacion = $n;"; 
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/detalleNoticiaCOMU.css" media="screen">
...
<body>
	...
	<div id="contenedorContenido">
		...
		<?php
			...
			while ($mostrarCOMU = mysql_fetch_row($result))
	    	{
		
				echo '<div id="contenidoCOMU">

						<div id="contenidoPlantilla">
							'."	<h1 id='titulo'>"	.$mostrarCOMU[7].	"</h1>".'
								<h5 id="org">'		.$mostrarCOMU[1].	"</h5>".'
								<textarea id="contenido" readonly>'		.$mostrarCOMU[9].	"</textarea>".'
						</div>
