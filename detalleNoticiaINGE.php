<?php
    ...
    $sql = "SELECT 	pub.ID_Publicacion AS n,
			...
			WHERE cat.ID_Categoria = 'INVI' AND pub.ID_Subcategoria='INGE' AND pub.Estatus='A' AND pub.Estado='PUBLICADA' AND pub.ID_Publicacion = $n;"; 
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/detalleNoticiaINGE.css" media="screen">
...
<body>
	...
	<div id="contenedorContenido">
		...
		<?php
			...
			while ($mostrarINGE = mysql_fetch_row($result))
	    	{
		
				echo '<div id="contenidoCOMU">

						<div id="contenidoPlantilla">
							'."	<h1 id='titulo'>"	.$mostrarINGE[7].	"</h1>".'
								<h5 id="org">'		.$mostrarINGE[1].	"</h5>".'
								<textarea id="contenido" readonly>'		.$mostrarINGE[9].	"</textarea>".'
						</div>
