...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/detalle/detalleNuevoAcenso.css" media="all"/>
        ...
        const deatalle = new Vue({
            ...
            methods: {
                getPublicaciones: function() {
                    this.$http.get('php/detalle/detalleAscenso.php?id='+getParamURL('id')).then((responsed) => {
