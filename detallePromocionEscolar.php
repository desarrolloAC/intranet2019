...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/detalle/detallePromocionEscolar.css" media="all"/>
        ...
        const deatalle = new Vue({
            ...
            methods: {
                getPublicaciones: function() {
                    this.$http.get('php/detalle/detallePromocion.php?id='+getParamURL('id')).then((responsed) => {
