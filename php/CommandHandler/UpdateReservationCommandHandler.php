...
/**
 * Description of UpdateAvailabilityCommandHandler
 *
 * @author braya
 */
class UpdateReservationCommandHandler implements ICommandHandler {
     ...
     * Ejecutar la accion.
     * 
     * @param Reservation $action
     */
    public function handler($handler) {
       
        $this->service->beginTransaction();
        $this->service->updateReservation($handler);
        $this->service->commint();
        
        $result = $this->service->getReservations($handler->getAvailabilityId());
