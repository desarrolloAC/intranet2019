...
<div id="formularioComunicado" class="contenedorFormulario">
    ...
    <div id="formularioComunicado">
        ...
        <form method="POST" action="php/publicaciones/registrarPublicacionComunicado.php">
            ...
            <input id="txtCodigoSubCategoriaComunicado" type="text" name="txtCodigoSubCategoriaComunicado" value="COMU" maxlength="4">
            ...
            <textarea id="txtContenidoComunicado"
                      name="txtContenidoComunicado"
                      onKeyDown="textCounter(this.form.txtContenidoComunicado, this.form.remLen, 500);"
                      onKeyUp="textCounter(this.form.txtContenidoComunicado, this.form.remLen, 500);"
