...
include_once $_SERVER["DOCUMENT_ROOT"] . '/intranet/php/detalle/NuevoIngreso.php';
...
carg.Nombre AS cargo,
ingre.foto as image,
ingre.contenido
FROM publicacion pub
INNER JOIN publicacion_nuevoingreso ingre ON ingre.ID_publicacion  = pub.ID_Publicacion
...
INNER JOIN cargo carg               	  ON carg.ID_Cargo  = ingre.cargo
INNER JOIN departamento dpto              ON dpto.ID_Departamento  = ingre.departamento
