<?php
	...
	$consulta = mysql_query("SELECT * FROM categoria WHERE ID_Categoria ='$codigo'",$conexion);
	...
	{
	   $query=" INSERT INTO categoria VALUES('$codigo','$nombre',DEFAULT,NOW(),'$_SESSION[Cedula]',NOW(),'$_SESSION[Cedula]','$descripcion')";
	   $agregarCategoria = mysql_query ($query,$conexion);
