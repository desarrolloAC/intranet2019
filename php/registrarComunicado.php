<?php
	...
	$updateBy 			= $_SESSION['Cedula'];
 	...
 	$agregarPublicacion = mysql_query("INSERT INTO publicacion VALUES(NULL,'$idOrganizacion','$idSubCategoria','$cedula','$contenido',DEFAULT,NULL,'$titulo',DEFAULT,NULL,now(),'$createdBy',now(),'$updateBy',NULL,NULL)",$conexion);
