<?php
    ...
    $contenido2         = $_POST['txtContenidoInvitacionGeneral2'];
    if (isset($_FILES['btnImagenInvitacionGeneral']['error'])) {
        $error          = $_FILES['btnImagenInvitacionGeneral']['error'];
    }
    if (isset( $_FILES['btnImagenInvitacionGeneral']['name'])) {
        $foto           =$_FILES['btnImagenInvitacionGeneral']['name'];
    }

    if (isset($_FILES['btnImagenInvitacionGeneral']['type'])) {
        $type           = $_FILES['btnImagenInvitacionGeneral']['type'];
    }
    ...
    else
    {
        ...
        {
            $ruta              = $_FILES['btnImagenInvitacionGeneral']['tmp_name'];
    ...
    print_r($idOrganizacion);
    $agregarPublicacion = mysqli_query($conexion,"INSERT INTO publicacion VALUES(NULL,'$idOrganizacion','$idSubCategoria','$cedula','$contenido','$contenido2',DEFAULT,'$destino_temp','$titulo',DEFAULT,NULL,now(),'$createdBy',now(),'$updateBy',NULL,NULL)");
