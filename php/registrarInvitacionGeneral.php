<?php
    ...
    $agregarPublicacion = mysql_query("INSERT INTO publicacion VALUES(NULL,'$idOrganizacion','$idSubCategoria','$cedula','$contenido','$contenido2',DEFAULT,'$destino_temp','$titulo',DEFAULT,NULL,now(),'$createdBy',now(),'$updateBy',NULL,NULL)",$conexion);
