...
<table id="tabla_publicacion" border="1">
	...
	<tbody>
      ...
      switch ($_SESSION['ID_Rol']) {
        ...
        while($mostrarPublicacion = mysql_fetch_array($consultaPublicacion))
        {
      ?>
		<tr id="datos_usuario">
			<td>
					                 ...
					                 /*INGRESAR EL USUARIO COMO ADMINISTRADOR*/ 
						                switch ($mostrarPublicacion['Estado']) {
									     	...
									     	case EstadoPublicacion::REVISION_A:
									     		...
									     		break;
									     	case EstadoPublicacion::PUBLICADA:
									     		 //echo"<a id='btnDesactivado'    name='btnDesactivado'  href='php/actualizarEstadoPublicacion.php?codigo=$mostrarPublicacion[ID_Publicacion]&estado=REVISION_E&usuario=$_SESSION[Cedula]' title='Enviar a Editor'>Enviar a Editor</a>";
									     		break;
									     	default:
