<table id="tabla_rol" border="1">
    ...
    <tbody>
		...
		<tr id="datos_usuario">
			<td>
				<h5><?php echo $mostrarRol['codigo'];?></h5>
			</td>

			<td>
				<h5><?php echo $mostrarRol['nombre'];?></h5>
			</td>
			...
			<td>
				<h5><?php echo $mostrarRol['Descripcion'];?></h5>
			</td>
			...
			<td>
				<h5><?php echo $mostrarRol['Created'];?></h5>
			</td>
			...
			<td>
				<h5><?php echo $mostrarRol['Updated'];?></h5>
			</td>
