...
<table id="tabla_usuario" border="1">
	...
	<tbody>
		 ...
		 <tr id="datos_usuario" class="ancho">
			<td class="ancho">
				<h5><?php echo $mostrarUsuario['codigo'];?></h5>
			</td>

			<td class="ancho">
				<h5><?php echo $mostrarUsuario['nombre'];?></h5>
			</td>
			<td class="ancho">
				<h5><?php echo $mostrarUsuario['Apellido'];?></h5>
			</td>
			<td class="ancho">
			...
			<td class="ancho">
			   <h5><?php echo $mostrarUsuario['Telefono'];?></h5>
			</td>

			<td class="ancho">
				<h5><?php echo $mostrarUsuario['Direccion'];?></h5>
			</td>
			<td class="ancho">
				<h5><?php echo $mostrarUsuario['organizacion'];?></h5>
			</td>

			<td class="ancho">
				<h5><?php echo $mostrarUsuario['departamento'];?></h5>
			</td>

			<td class="ancho">
				<h5><?php echo $mostrarUsuario['cargo'];?></h5>
			</td>
