...
<header class="contenedorTop">
    ...
    <ul class="menu">
            ...
            <ul>
                ...
                <li class="menu-desp1">
                    ...
                    <ul>
                        ...
                        <li><a href="http://192.168.0.130/site/PROCESOS/Documentos/Mision_y_Vision/IEC/mision_vision_IEC.pdf" target="_blank">Ind. El Caimán</a></li>
                ...
                <li class="menu-desp2">
                    ...
                    <ul>
                        ...
                        <li><a href="http://192.168.0.130/site/procesos/Documentos/PO-TI-001.pdf" target="_blank">Tecnología de la Información</a></li>
        ...
        <li>
            <a href="#" title="">Enlaces de interés</a>
            <ul>
    ...
    <ul class="menu-list accordion">
        ...
        <ul class="menu-submenu accordion-content">
            ...
            <li class="accordion-toggle2">
                <a class="menu-link" href="#">Gerencia Estratégica</a>
            </li>
            <ul class="menu-submenu accordion-content2">
                ...
                <ul class="menu-submenu accordion-content3">
                    <li><a class="head" href="assets/document/gerencia-estrategica/F-SG-006%20CP%20V7%20Gerencia%20Estrat%C3%A9gica.pdf" target="_blank">Gerencia Estratègica</a></li>
                    <li><a class="head" href="http://192.168.0.130/SITE/PROCESOS/Gerencia Estrategica/CP GE ASIGNACION DE RECURSOS/index.html" target="_blank" target="_blank">Asignación de Recursos</a></li>
                </ul>
            ...
            <li class="accordion-toggle2">
                ...
                <li><a class="head" href="http://192.168.0.130/site/procesos/Comercial/index.html#list" target="_blank">Ciclo de Comercialización</a></li>
            ...
            <ul class="menu-submenu accordion-content2">
                ...
                <li><a class="head" href="assets/document/logistica/instructivos/I-LG-006 INSTRUCTIVO PARA EL TRASPASO DE MERCANCIA ENTRE ALMACENES.pdf">Instructivo I-LG-006</a></li>
                <li><a class="head" href="assets/document/logistica/instructivos/I-LG-007 INSTRUCTIVO PARA REALIZAR DEVOLUCIONES DE PRODUCTOS A NIVEL DE SISTEMA.pdf">Instructivo I-LG-007</a></li>
                </ul>
            <!-- Asuntos Legales -->
            <li class="accordion-toggle2">
            ...
            <ul class="menu-submenu accordion-content2">
                ...
                <ul class="menu-submenu accordion-content3">
                    ...
                    <li><a class="head" href="http://192.168.0.130/site/procesos/Finanzas/Impuestos/index.html#list" target="_blank">Procedimientos</a></li>
                   </ul>
                ...
                <ul class="menu-submenu accordion-content3">
                    ...
                    <li><a class="head" href="http://192.168.0.130/site/procesos/Finanzas/Cuentas%20por%20Pagar/index.html#list" target="_blank">Procedimientos</a></li>
                   </ul>
                ...
                <ul class="menu-submenu accordion-content3">
                    ...
                    <li><a class="head" href="http://192.168.0.130/site/procesos/Finanzas/Tesoreria/index.html#list" target="_blank">Procedimientos</a></li>
                   </ul>
                ...
                <ul class="menu-submenu accordion-content3">
                    ...
                    <li><a class="head" href="http://192.168.0.130/site/procesos/Finanzas/Gestion%20financiera/index.html#list" target="_blank">Procedimientos</a></li>
                   </ul>
                ...
                <ul class="menu-submenu accordion-content3">
                    ...
                    <li><a class="head" href="http://192.168.0.130/site/procesos/Finanzas/Costos/Costos%20Produccion/index.html#list" target="_blank">Procedimientos</a></li>
                   </ul>
                ...
                <ul class="menu-submenu accordion-content3">
                    ...
                    <li><a class="head" href="http://192.168.0.130/site/procesos/Logistica/Control%20de%20Inventario/index.html#list" target="_blank">Procedimientos</a></li>
                   </ul>
        ...
        <ul class="menu-submenu accordion-content">
            ...
            <li class="accordion-toggle2">
                <a class="menu-link" href="#">Dpto. Seguridad Física</a>
            </li>
            <ul class="menu-submenu accordion-content2">
        ...
        <!-- Ind. El Caimàn -->
        <li class="accordion-toggle">
            <a class="menu-link" href="#">Ind. El Caimán</a>
        </li>
        <ul class="menu-submenu accordion-content">
            ...
            <ul class="menu-submenu accordion-content2">
                ...
                <li><a class="head" href="http://192.168.0.130/site/procesos/Documentos/Caracterizaciones/F-SG-006%20CONTROL%20DE%20CALIDAD.pdf" target="_blank">Caracterización de procesos</a></li>
                <li><a class="head" href="http://192.168.0.130/site/procesos/Operaciones%20El%20Caiman/Control%20DE%20Calidad/Intructivos%20y%20fichas%20tecnicas/index.html#list" target="_blank">Instructivos/Ficha Técnica</a></li>
            </ul>
            <!-- Producciòn -->
            <li class="accordion-toggle2">
                <a class="menu-link" href="#">Producción</a>
            ...
            <ul class="menu-submenu accordion-content2">
                ...
                <li><a class="head" href="http://192.168.0.130/site/procesos/Documentos/Caracterizaciones/F-SG-006-PRODUCCION-IEC.pdf" target="_blank">Caracterización de procesos</a></li>
