...
<header class="contenedorTop">
    ...
    <ul class="menu">
        ...
        <li>
            ...
            <ul>
                <li><a href="http://adempierealkespro/webui/" target="_blank">Adempiere-Alkes</a></li>
                <li><a href="http://adempieretkr8080/webui/" target="_blank">Adempiere-TKR</a></li>
...
<div id="menu-container">
    ...
    <ul class="menu-list accordion">
        ...
        <ul class="menu-submenu accordion-content">
            ...
            <ul class="menu-submenu accordion-content2">
                ...
                <ul class="menu-submenu accordion-content3">
                    ...
                    <li><a class="head" href="http://192.168.0.10/sig/PROCESOS/Gerencia Estrategica/CP GE ASIGNACION DE RECURSOS/index.html" target="_blank" target="_blank">Asignación de Recursos</a></li>
                </ul>
                <li><a class="head" href="http://192.168.0.10/sig/PROCESOS/Gerencia%20Estrategica/index.html#list" target="_blank">Procedimientos</a></li>
            </ul>
            ...
            <ul class="menu-submenu accordion-content2">
                ...
                <li><a class="head" href="http://192.168.0.10/sig/PROCESOS/Comercio%20Exterior/index.html#list" target="_blank">Procedimientos</a></li>
            </ul>
            <!-- Ingenieria -->
            <li class="accordion-toggle2">
            ...
            <ul class="menu-submenu accordion-content2">
                ...
                <ul class="menu-submenu accordion-content3">
                    <li><a class="head" href="http://192.168.0.10/sig/PROCESOS/Ingenieria/Proyecto/index.html#list" target="_blank">Proyecto</a></li>
                    <li><a class="head" href="http://192.168.0.10/sig/PROCESOS/Ingenieria/Mantenimiento/index.html#list" target="_blank">Mantenimiento</a></li>
                </ul>
            </ul>
            <!-- Finanzas -->
            <li class="accordion-toggle2">
        ...
        <ul class="menu-submenu accordion-content">
            ...
            <ul class="menu-submenu accordion-content2">
                <li><a class="head" href="http://192.168.0.10/sig/PROCESOS/Operaciones%20Venfruca/Ambiente/index.html#list" target="_blank">Procedimientos</a></li>
            </ul>
            ...
            <ul class="menu-submenu accordion-content2">
                <li><a class="head" href="http://192.168.0.10/sig/PROCESOS/Operaciones%20Venfruca/Mantenimiento/index.html#list" target="_blank">Procedimientos</a></li>
            </ul>
            <!-- Mantenimiento -->
            <li class="accordion-toggle2">
            ...
            <ul class="menu-submenu accordion-content2">
                ...
                <li><a class="head" href="http://192.168.0.10/sig/PROCESOS/Operaciones%20Venfruca/Produccion/index.html#list" target="_blank">Procedimientos</a></li>
            </ul>
            <!-- Seguridad y Salud Laboral -->
            <li class="accordion-toggle2">
                <a class="menu-link" href="#">Seguridad y Salud Laboral</a>
            ...
            <ul class="menu-submenu accordion-content2">
                <li><a class="head" href="http://192.168.0.10/sig/PROCESOS/Operaciones%20Venfruca/Seguridad%20Laboral/index.html#list" target="_blank">Procedimientos</a></li>
            </ul>
            <!-- Desarrollo Agrario -->
            <li class="accordion-toggle2">
            ...
            <ul class="menu-submenu accordion-content2">
                <li><a class="head" href="http://192.168.0.10/sig/PUBLICADOS/OPERACIONES%20VENFRUCA/SEGURIDAD%20FISICA/index.html#list" target="_blank">Procedimientos</a></li>
            ...
            <ul class="menu-submenu accordion-content2">
                <li><a class="head" href="http://192.168.0.10/sig/PROCESOS/Operaciones%20Venfruca/Planificación/index.html#list" target="_blank">Procedimientos</a></li>
            </ul>
